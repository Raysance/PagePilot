...
export const POPUP_TRANSLATIONS = {
    ...
    en: {
        ...
        loading: "Analyzing and grouping tabs...",
        success: "Tabs grouped successfully.",
        options: "⚙️ Settings & Prompts",
        error: "Grouping failed, please check network or API settings.",
